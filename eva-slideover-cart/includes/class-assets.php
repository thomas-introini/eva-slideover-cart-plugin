		...
		wp_localize_script(
			...
			[
				...
				'i18n'         => [
					...
					'errorOffline'    => __( 'You are offline. Check your connection and try again.', 'eva-slideover-cart' ),
					'errorTimeout'    => __( 'The request took too long. Please try again.', 'eva-slideover-cart' ),
					'errorValidation' => __( 'Check the entered data and try again.', 'eva-slideover-cart' ),
					'errorPermission' => __( 'Your session has expired or you do not have permission.', 'eva-slideover-cart' ),
					'errorNotFound'   => __( 'This item is no longer available in your cart.', 'eva-slideover-cart' ),
					'errorRateLimit'  => __( 'Too many requests. Please wait and try again.', 'eva-slideover-cart' ),
					'errorServer'     => __( 'Temporary server error. Please try again shortly.', 'eva-slideover-cart' ),
					'errorConfig'     => __( 'Cart configuration is incomplete. Reload the page.', 'eva-slideover-cart' ),
					'retry'           => __( 'Retry', 'eva-slideover-cart' ),
