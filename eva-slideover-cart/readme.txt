...
* Live cart updates via WooCommerce native fragments, including classic and Cart Block cart-page updates (no page reload)
...
* Live subtotal, applied coupon effects, shipping, and total breakdown; shipping is marked as calculated at checkout when no rate is available
